...
const skills = [
  ...
  { name: "TensorFlow", level: 60, category: "libraries" },
  { name: "PyTorch", level: 60, category: "libraries" },
  { name: "LangChain", level: 60, category: "libraries" },
  { name: "OpenAI", level: 70, category: "libraries" },
